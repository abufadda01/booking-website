    ...
    <div>
      ...
      <div className="hotelContainer">
        ...
        {openSlide && <div className="slider">
            ...
            <FontAwesomeIcon icon={faCircleXmark} className='close' onClick={() => setOpenSlide(!openSlide)} />
        ...
        <div className="hotelWrapper">
            ...
            <div className="hotelImages">
              {data.photos && data.photos.map((photo , i) => {
                return (
                  <div className='hotelImagesWrapper' key={i}>
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsText">
                ...
                <h1 className='hotelTile'>{data.title}</h1>
